...
- **Only the project architect** may modify, add, or remove encryption algorithms, key derivation functions, or cryptographic primitives.
...
- **Rationale**: Encryption is the foundation of trust. A single mistake in key derivation or algorithm implementation can compromise all people's data. Centralizing crypto changes under the architect minimizes this risk.
