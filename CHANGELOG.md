...
### Added
- Initial release of CrytoTool Vault
- IndexedDB encryption with AES-256-GCM
- Master Password protection via Argon2id
...
### Version 2.5.0-PRO
This is the first professional release with complete documentation, enhanced security measures, and a polished UI. All data is encrypted client-side, and the application respects the privacy of the people using it.

### Upgrade Notes
- Existing people: Your vault data remains encrypted and compatible
- New security measures (encrypted localStorage items) are applied automatically
- If upgrading from pre-2.5.0, recovery codes will be migrated to encrypted format on next save
